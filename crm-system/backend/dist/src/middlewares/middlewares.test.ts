...
import { InvalidClient } from "../utils/erros.ts";
...
describe("errorHandler", () => {
    ...
    it("returns the error status and message outside production", () => {
        ...
        const erro = new InvalidClient("Invalid client");
        errorHandler(erro, request, response, vi.fn());
    ...
    it("hides internal error details in production", () => {
        ...
        expect(response.json).toHaveBeenCalledWith({ erro: "Erro interno do servidor" });
    });
});
